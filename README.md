...
1. Set your new VMs to start automatically each time the physical host machine finishes booting. Run (**on the physical host machine**):
   ...
   ```
1. Almost done! All that's left is configuring your reverse proxy. To do this, you first need to install it. Run (**on the physical host machine**):
   ```shell
